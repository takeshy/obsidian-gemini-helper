...
보드 정의를 `Dashboards/Kanbans/` 아래의 재사용 가능한 `.kanban` YAML 파일로 저장할 수 있습니다. 기존 파일을 선택하거나 **현재 설정에서 .kanban 파일 만들기**를 사용하세요. 여러 대시보드가 같은 정의를 공유할 수 있으며 카드 순서는 각 대시보드 위젯에 개별적으로 유지됩니다.
