...
> **有關設定說明和範例，請參閱 [SKILLS.md](docs/SKILLS_zh.md)**
...
> **詳細的節點規格和範例，請參閱 [WORKFLOW_NODES.md](docs/WORKFLOW_NODES_zh.md)**
...
> **提示：** 要一次加密目錄中的所有檔案，請使用工作流。參見 [WORKFLOW_NODES_zh.md](docs/WORKFLOW_NODES_zh.md#obsidian-command) 中的「加密目錄中的所有檔案」範例。
