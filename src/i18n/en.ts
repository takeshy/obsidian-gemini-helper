...
export const en = {
  ...
  "driveSync.backupTokenDesc": "Paste the backup token from GemiHub settings (Obsidian Sync section)",
  "driveSync.backupTokenPlaceholder": "Paste backup token here",
  "driveSync.setupConnection": "Setup connection",
  "driveSync.setupConnectionDesc": "Fetch encrypted auth from Google Drive using backup token",
  "driveSync.setup": "Setup",
  "driveSync.settingUp": "Setting up...",
  "driveSync.pasteTokenFirst": "Please paste a backup token first",
  ...
  "driveSync.tempUploadDone": "Temp uploaded to __TEMP__/",
