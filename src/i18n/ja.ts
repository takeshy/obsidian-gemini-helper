...
export const ja: Record<string, string> = {
  ...
  // Settings - Local LLM
  "settings.localLlmDesc": "OpenAI互換API（Ollama、LM Studio、llama.cpp、vLLMなど）",
  "settings.localLlmSettings": "Local LLMの設定",
  "settings.localLlmVerifying": "接続を確認中...",
  "settings.localLlmVerified": "Local LLMが検証されました",
  "settings.localLlmDisabled": "Local LLMが無効化されました",
  "settings.localLlmConnectionFailed": "接続に失敗しました: ",
  "settings.localLlmNoModel": "先に設定でモデル名を指定してください",
  "settings.localLlmConfigSaved": "Local LLMの設定を保存しました",
  "settings.localLlmModal.title": "Local LLM設定",
  "settings.localLlmModal.desc": "OpenAI互換APIを持つローカルLLMサーバーを設定します。Ollama、LM Studio、llama.cpp、vLLM、LocalAIなどに対応しています。",
  "settings.localLlmModal.baseUrl": "ベースURL",
  "settings.localLlmModal.baseUrlDesc": "サーバーのエンドポイントURL（例: Ollamaの場合 http://localhost:11434、LM Studioの場合 http://localhost:1234）",
  "settings.localLlmModal.baseUrlRequired": "ベースURLは必須です",
  "settings.localLlmModal.apiKey": "APIキー（オプション）",
  "settings.localLlmModal.apiKeyDesc": "認証が必要なプロバイダー向け",
  "settings.localLlmModal.apiKeyPlaceholder": "sk-...",
  "settings.localLlmModal.model": "モデル",
  "settings.localLlmModal.modelDesc": "サーバーから選択するか手動入力",
  "settings.localLlmModal.modelPlaceholder": "例: llama3, mistral, gemma2",
  "settings.localLlmModal.fetchModels": "モデル取得",
  "settings.localLlmModal.fetching": "取得中...",
  "settings.localLlmModal.noModelsFound": "サーバーにモデルが見つかりません",
  "settings.localLlmModal.modelsLoaded": "{{count}}個のモデルを読み込みました",
  "settings.localLlmModal.testConnection": "接続テスト",
