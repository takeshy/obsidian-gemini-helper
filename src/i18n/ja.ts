...
export const ja: Record<string, string> = {
  ...
  "driveSync.backupToken": "バックアップトークン",
  "driveSync.backupTokenDesc": "GemiHubの設定（Obsidian Syncセクション）からバックアップトークンを貼り付け",
  "driveSync.backupTokenPlaceholder": "バックアップトークンを貼り付け",
  "driveSync.setupConnection": "接続設定",
  "driveSync.setupConnectionDesc": "バックアップトークンを使用してGoogle Driveから暗号化認証を取得",
  "driveSync.setup": "設定",
  "driveSync.settingUp": "設定中...",
  "driveSync.pasteTokenFirst": "バックアップトークンを貼り付けてください",
  ...
  "driveSync.tempUploadDone": "__TEMP__/ に一時保存しました",
