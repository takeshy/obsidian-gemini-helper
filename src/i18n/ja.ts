...
export const ja: Record<string, string> = {
  ...
  "message.deepResearchStarted": "深い調査を開始しました",
  "message.deepResearchInProgress": "深い調査を実行中...",
  "message.deepResearchCompleted": "深い調査が完了しました",
  "message.deepResearchFailed": "深い調査が失敗しました",
  "message.deepResearchThinking": "思考中",
  "message.viewResult": "結果を見る",
