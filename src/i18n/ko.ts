...
export const ko: Record<string, string> = {
  ...
  // Settings - Local LLM
  "settings.localLlmDesc": "OpenAI 호환 API (Ollama, LM Studio, llama.cpp, vLLM 등)",
  "settings.localLlmSettings": "Local LLM 설정",
  "settings.localLlmVerifying": "연결 확인 중...",
  "settings.localLlmVerified": "Local LLM 확인됨",
  "settings.localLlmDisabled": "Local LLM 비활성화됨",
  "settings.localLlmConnectionFailed": "연결 실패: ",
  "settings.localLlmNoModel": "먼저 설정에서 모델 이름을 지정하세요",
  "settings.localLlmConfigSaved": "Local LLM 설정이 저장되었습니다",
  "settings.localLlmModal.title": "Local LLM 설정",
  "settings.localLlmModal.desc": "OpenAI 호환 API를 사용하는 로컬 LLM 서버를 설정합니다. Ollama, LM Studio, llama.cpp, vLLM, LocalAI 등을 지원합니다.",
  "settings.localLlmModal.baseUrl": "기본 URL",
  "settings.localLlmModal.baseUrlDesc": "서버 엔드포인트 URL (예: Ollama의 경우 http://localhost:11434, LM Studio의 경우 http://localhost:1234)",
  "settings.localLlmModal.baseUrlRequired": "기본 URL은 필수입니다",
  "settings.localLlmModal.apiKey": "API 키 (선택사항)",
  "settings.localLlmModal.apiKeyDesc": "인증이 필요한 제공자용",
  "settings.localLlmModal.apiKeyPlaceholder": "sk-...",
  "settings.localLlmModal.model": "모델",
  "settings.localLlmModal.modelDesc": "서버에서 선택하거나 수동 입력",
  "settings.localLlmModal.modelPlaceholder": "예: llama3, mistral, gemma2",
  "settings.localLlmModal.fetchModels": "모델 가져오기",
  "settings.localLlmModal.fetching": "가져오는 중...",
  "settings.localLlmModal.noModelsFound": "서버에서 모델을 찾을 수 없습니다",
  "settings.localLlmModal.modelsLoaded": "{{count}}개 모델 로드됨",
  "settings.localLlmModal.testConnection": "연결 테스트",
