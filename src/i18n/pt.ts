...
export const pt: Record<string, string> = {
  ...
  // Settings - Local LLM
  "settings.localLlmDesc": "API compatível com OpenAI (Ollama, LM Studio, llama.cpp, vLLM, etc.)",
  "settings.localLlmSettings": "Configurar LLM local",
  "settings.localLlmVerifying": "Verificando conexão...",
  "settings.localLlmVerified": "LLM local verificado",
  "settings.localLlmDisabled": "LLM local desativado",
  "settings.localLlmConnectionFailed": "Falha na conexão: ",
  "settings.localLlmNoModel": "Configure um nome de modelo nas configurações primeiro",
  "settings.localLlmConfigSaved": "Configurações do LLM local salvas",
  "settings.localLlmModal.title": "Configurações do LLM local",
  "settings.localLlmModal.desc": "Configure um servidor LLM local com API compatível com OpenAI. Suporta Ollama, LM Studio, llama.cpp, vLLM, LocalAI e mais.",
  "settings.localLlmModal.baseUrl": "URL base",
  "settings.localLlmModal.baseUrlDesc": "URL do endpoint do servidor (ex. http://localhost:11434 para Ollama, http://localhost:1234 para LM Studio)",
  "settings.localLlmModal.baseUrlRequired": "A URL base é obrigatória",
  "settings.localLlmModal.apiKey": "Chave API (opcional)",
  "settings.localLlmModal.apiKeyDesc": "Necessária por alguns provedores para autenticação",
  "settings.localLlmModal.apiKeyPlaceholder": "sk-...",
  "settings.localLlmModal.model": "Modelo",
  "settings.localLlmModal.modelDesc": "Selecionar do servidor ou digitar manualmente",
  ...
  "settings.localLlmModal.noModelsFound": "Nenhum modelo encontrado no servidor",
  "settings.localLlmModal.modelsLoaded": "{{count}} modelo(s) carregado(s)",
  "settings.localLlmModal.testConnection": "Testar conexão",
  ...
  "driveSync.pushChanges": "Enviar para Drive",
  "driveSync.pullChanges": "Trazer para local",
  "driveSync.noFilesToSync": "Nenhum arquivo para sincronizar.",
  "driveSync.push": "Enviar para Drive",
  "driveSync.pull": "Trazer para local",
  "driveSync.deletedOnRemote": "excluído remotamente",
  "driveSync.conflict": "Conflito",
  "driveSync.conflictNeedResolve": "Conflito (requer resolução)",
  ...
  "driveSync.unlockTitle": "Desbloqueio do sync com Drive",
  "driveSync.unlockDesc": "Digite sua senha para desbloquear o sync com o Google Drive nesta sessão.",
  "driveSync.password": "Senha",
  "driveSync.passwordPlaceholder": "Senha de criptografia",
  "driveSync.unlock": "Desbloquear",
  "driveSync.skip": "Pular",

  // Drive Sync - Conflict Modal
  "driveSync.conflictTitle": "Conflitos no sync com Drive",
  "driveSync.conflictDesc": "{{count}} arquivo(s) foram modificados local e remotamente. Escolha qual versão manter para cada arquivo.",
  "driveSync.keepAllLocal": "Manter todos locais",
  "driveSync.keepAllRemote": "Manter todos remotos",
  "driveSync.resolving": "Resolvendo conflitos...",
  "driveSync.resolveLater": "Resolver depois",
  "driveSync.localEditRemoteDelete": "Editado localmente, excluído remotamente",
  "driveSync.restorePush": "Restaurar (enviar para Drive)",
  "driveSync.restorePushTooltip": "Manter arquivo local e reenviar para o Drive",
  "driveSync.acceptDelete": "Aceitar exclusão",
  "driveSync.acceptDeleteTooltip": "Excluir arquivo local (backup salvo em sync_conflicts/)",
  "driveSync.keepLocal": "Manter local",
  "driveSync.keepRemote": "Manter remoto",

  // Drive Sync - Settings
  "driveSync.heading": "Sincronização com Google Drive",
  "driveSync.enable": "Ativar sincronização com Drive",
  "driveSync.enableDesc": "Sincronize seu cofre do Obsidian com o Google Drive (compatível com GemiHub)",
  "driveSync.backupToken": "Token do Migration Tool",
  "driveSync.backupTokenDesc": "Cole o token criado pelo Migration Tool do GemiHub",
  "driveSync.backupTokenPlaceholder": "Cole o token do Migration Tool aqui",
  "driveSync.setupConnection": "Configurar conexão",
  "driveSync.setupConnectionDesc": "Obter autenticação criptografada do Google Drive usando o token do Migration Tool",
  "driveSync.setup": "Configurar",
  "driveSync.settingUp": "Configurando...",
  "driveSync.pasteTokenFirst": "Por favor, cole um token do Migration Tool primeiro",
  "driveSync.configured": "Sincronização com Drive configurada! Digite sua senha para desbloquear.",
  "driveSync.setupFailed": "Falha na configuração: {{error}}",
  "driveSync.connectionStatus": "Status da conexão",
  "driveSync.connectedDesc": "Desbloqueado e conectado ao Google Drive",
  "driveSync.lockedDesc": "Configurado, mas bloqueado. Digite sua senha para desbloquear esta sessão.",
  "driveSync.resetAuth": "Redefinir autenticação",
  "driveSync.resetAuthConfirm": "Isso removerá a autenticação criptografada salva. Você precisará exportar do GemiHub novamente. Continuar?",
  "driveSync.authReset": "Autenticação da sincronização com Drive redefinida",
  "driveSync.autoSyncCheck": "Verificação automática de sincronização",
  "driveSync.autoSyncCheckDesc": "Verificar automaticamente alterações remotas periodicamente e atualizar contadores",
  "driveSync.syncInterval": "Intervalo de verificação (minutos)",
  "driveSync.syncIntervalDesc": "Com que frequência verificar alterações remotas",
  "driveSync.excludePatterns": "Padrões de exclusão",
  "driveSync.excludePatternsDesc": "Caminhos a excluir da sincronização (um por linha, suporta curingas *)",
  "driveSync.syncActions": "Ações de sincronização",
  "driveSync.fullPull": "Download completo para local",
  "driveSync.fullPullConfirm": "O download completo substituirá todos os arquivos locais pelas versões remotas. Isso não pode ser desfeito. Continuar?",
  "driveSync.refreshStatus": "Atualizar status de sincronização",
  "driveSync.refreshStatusDesc": "Verificar alterações locais e remotas",
  "driveSync.refresh": "Atualizar",

  // Drive Sync - Data Management
  "driveSync.tempFiles": "Arquivos temporários",
  "driveSync.tempFilesDesc": "Arquivos salvos temporariamente pelo GemiHub",
  "driveSync.tempFilesTitle": "Arquivos temporários",
  "driveSync.tempFilesNoFiles": "Nenhum arquivo temporário encontrado.",
  "driveSync.tempFilesSavedAt": "Salvo: {{date}}",
  "driveSync.tempFilesApply": "Aplicar selecionados",
  "driveSync.tempFilesApplyConfirm": "Aplicar arquivos temporários selecionados ao cofre? Arquivos existentes serão sobrescritos.",
  "driveSync.tempFilesDelete": "Excluir selecionados",
  "driveSync.tempFilesDeleteConfirm": "Excluir permanentemente os arquivos temporários selecionados?",
  "driveSync.selectAll": "Selecionar tudo",
  "driveSync.conflictBackups": "Backups de conflitos",
  "driveSync.conflictBackupsDesc": "Arquivos de backup criados durante a resolução de conflitos",
  "driveSync.conflictBackupsTitle": "Backups de conflitos",
  "driveSync.conflictBackupsNoFiles": "Nenhum backup de conflito encontrado.",
  "driveSync.conflictRestore": "Restaurar selecionados",
  "driveSync.conflictDelete": "Excluir selecionados",
  "driveSync.conflictDeleteConfirm": "Excluir permanentemente os backups de conflitos selecionados?",
  "driveSync.trash": "Lixeira",
  "driveSync.trashDesc": "Arquivos excluídos durante a sincronização",
  "driveSync.trashTitle": "Lixeira",
  "driveSync.trashNoFiles": "Nenhum arquivo na lixeira.",
  "driveSync.trashRestore": "Restaurar selecionados",
  "driveSync.trashDeletePermanently": "Excluir permanentemente",
  "driveSync.trashDeleteConfirm": "Excluir permanentemente os arquivos selecionados? Isso não pode ser desfeito.",
  "driveSync.manage": "Gerenciar",
  "driveSync.preview": "Pré-visualização",
  "driveSync.previewBinary": "Arquivo binário — pré-visualização não disponível",
  "driveSync.previewFailed": "Falha ao carregar a pré-visualização",
  "driveSync.processing": "Processando...",
  "driveSync.applied": "{{count}} arquivo(s) aplicado(s)",
  "driveSync.restored": "{{count}} arquivo(s) restaurado(s)",
  "driveSync.deleted": "{{count}} arquivo(s) excluído(s)",

  // Drive Sync - Plugin UI
  "driveSync.commandPush": "Sync do Drive: Enviar para Drive",
  "driveSync.commandPull": "Sync do Drive: Trazer para local",
  "driveSync.commandFullPush": "Sync do Drive: Envio completo para Drive",
  "driveSync.commandFullPull": "Sync do Drive: Download completo para local",
  "driveSync.notUnlocked": "Drive sync não desbloqueado. Digite sua senha primeiro.",
  "driveSync.unlocked": "Drive sync desbloqueado",
  "driveSync.unlockFailed": "Falha ao desbloquear Drive sync: {{error}}",
  "driveSync.ribbonPush": "Enviar para Drive",
  "driveSync.ribbonPull": "Trazer para local",
  "driveSync.ribbonPushCount": "Enviar para Drive ({{count}})",
  "driveSync.ribbonPullCount": "Trazer para local ({{count}})",
  "driveSync.statusLocked": "Drive: bloqueado",
  "driveSync.statusLockedTooltip": "Clique para desbloquear o sync com Drive",
  "driveSync.statusPushing": "Enviando para Drive...",
  "driveSync.statusPulling": "Trazendo para local...",
  "driveSync.statusConflict": "Drive: conflito",
  "driveSync.statusSynced": "Drive: sincronizado",
  "driveSync.statusChanges": "Drive: {{changes}}",
  "driveSync.statusTooltip": "Clique para ações de sync com Drive",
  "driveSync.statusError": "Drive sync: {{error}}",
  "driveSync.pushFailed": "Envio para Drive falhou: {{error}}",
  "driveSync.pullFailed": "Download para local falhou: {{error}}",
  "driveSync.refreshCounts": "Atualizar contagens",
  "driveSync.tempUpload": "Upload temporário",
  "driveSync.tempDownload": "Download temporário",
  "driveSync.tempUploadDone": "Enviado para o diretório temporário",
  "driveSync.tempDownloadDone": "Arquivo temporário aplicado ao vault",
  "driveSync.tempNotFound": "Nenhum arquivo temporário encontrado para este arquivo",
  "driveSync.loadingFileList": "Carregando lista de arquivos...",
  "driveSync.pushBlockedByRemote": "O remoto tem alterações pendentes. Faça pull primeiro.",
  "driveSync.startPushing": "Enviando para o Drive...",
  "driveSync.startPulling": "Baixando do Drive...",
  "driveSync.startFullPulling": "Pull completo do Drive...",
  "driveSync.startFullPushing": "Push completo para o Drive...",
