...
export const zh: Record<string, string> = {
  ...
  // Settings - Local LLM
  "settings.localLlmDesc": "OpenAI 兼容 API（Ollama、LM Studio、llama.cpp、vLLM 等）",
  "settings.localLlmSettings": "配置本地 LLM",
  "settings.localLlmVerifying": "正在验证连接...",
  "settings.localLlmVerified": "本地 LLM 已验证",
  "settings.localLlmDisabled": "本地 LLM 已禁用",
  "settings.localLlmConnectionFailed": "连接失败：",
  "settings.localLlmNoModel": "请先在设置中配置模型名称",
  "settings.localLlmConfigSaved": "本地 LLM 设置已保存",
  "settings.localLlmModal.title": "本地 LLM 设置",
  "settings.localLlmModal.desc": "配置使用 OpenAI 兼容 API 的本地 LLM 服务器。支持 Ollama、LM Studio、llama.cpp、vLLM、LocalAI 等。",
  "settings.localLlmModal.baseUrl": "基础 URL",
  "settings.localLlmModal.baseUrlDesc": "服务器端点 URL（例如 Ollama 为 http://localhost:11434，LM Studio 为 http://localhost:1234）",
  "settings.localLlmModal.baseUrlRequired": "基础 URL 为必填项",
  "settings.localLlmModal.apiKey": "API 密钥（可选）",
  "settings.localLlmModal.apiKeyDesc": "部分提供商需要用于身份验证",
  "settings.localLlmModal.apiKeyPlaceholder": "sk-...",
  "settings.localLlmModal.model": "模型",
  "settings.localLlmModal.modelDesc": "从服务器选择或手动输入",
  "settings.localLlmModal.modelPlaceholder": "例如 llama3、mistral、gemma2",
  "settings.localLlmModal.fetchModels": "获取模型",
  "settings.localLlmModal.fetching": "获取中...",
  "settings.localLlmModal.noModelsFound": "服务器上未找到模型",
  "settings.localLlmModal.modelsLoaded": "已加载 {{count}} 个模型",
  "settings.localLlmModal.testConnection": "测试连接",
  ...
  "driveSync.pushChanges": "推送到云端",
  "driveSync.pullChanges": "拉取到本地",
  "driveSync.noFilesToSync": "没有需要同步的文件。",
  "driveSync.push": "推送到云端",
  "driveSync.pull": "拉取到本地",
  "driveSync.deletedOnRemote": "已在远端删除",
  "driveSync.conflict": "冲突",
  "driveSync.conflictNeedResolve": "冲突 (需解决)",
  "driveSync.open": "打开",
  "driveSync.diff": "Diff",
  "driveSync.hide": "隐藏",
  ...
  "driveSync.unlockTitle": "Drive 同步解锁",
  "driveSync.unlockDesc": "请输入密码以在本次会话中解锁 Google Drive 同步。",
  "driveSync.password": "密码",
  "driveSync.passwordPlaceholder": "加密密码",
  "driveSync.unlock": "解锁",
  "driveSync.skip": "跳过",

  // Drive Sync - Conflict Modal
  "driveSync.conflictTitle": "Drive 同步冲突",
  "driveSync.conflictDesc": "{{count}} 个文件在本地和远端均有修改，请为每个文件选择要保留的版本。",
  "driveSync.keepAllLocal": "全部保留本地",
  "driveSync.keepAllRemote": "全部保留远端",
  "driveSync.resolving": "正在解决冲突...",
  "driveSync.resolveLater": "稍后解决",
  "driveSync.localEditRemoteDelete": "本地已编辑，远端已删除",
  "driveSync.restorePush": "恢复（推送到云端）",
  "driveSync.restorePushTooltip": "保留本地文件并重新上传到 Drive",
  "driveSync.acceptDelete": "接受删除",
  "driveSync.acceptDeleteTooltip": "删除本地文件（备份至 sync_conflicts/）",
  "driveSync.keepLocal": "保留本地",
  "driveSync.keepRemote": "保留远端",

  // Drive Sync - Settings
  "driveSync.heading": "Google Drive 同步",
  "driveSync.enable": "启用 Drive 同步",
  "driveSync.enableDesc": "将您的 Obsidian 仓库与 Google Drive 同步（兼容 GemiHub）",
  "driveSync.backupToken": "Migration Tool 令牌",
  "driveSync.backupTokenDesc": "粘贴由 GemiHub Migration Tool 创建的令牌",
  "driveSync.backupTokenPlaceholder": "在此粘贴 Migration Tool 令牌",
  "driveSync.setupConnection": "配置连接",
  "driveSync.setupConnectionDesc": "使用 Migration Tool 令牌从 Google Drive 获取加密认证",
  "driveSync.setup": "配置",
  "driveSync.settingUp": "配置中...",
  "driveSync.pasteTokenFirst": "请先粘贴 Migration Tool 令牌",
  "driveSync.configured": "Drive 同步已配置！请输入密码以解锁。",
  "driveSync.setupFailed": "配置失败：{{error}}",
  "driveSync.connectionStatus": "连接状态",
  "driveSync.connectedDesc": "已解锁并连接到 Google Drive",
  "driveSync.lockedDesc": "已配置但已锁定。请输入密码以解锁此会话。",
  "driveSync.resetAuth": "重置认证",
  "driveSync.resetAuthConfirm": "这将删除已保存的加密认证。您需要从 GemiHub 重新导出。是否继续？",
  "driveSync.authReset": "Drive 同步认证已重置",
  "driveSync.autoSyncCheck": "自动同步检查",
  "driveSync.autoSyncCheckDesc": "定期自动检查远程更改并更新计数器",
  "driveSync.syncInterval": "检查间隔（分钟）",
  "driveSync.syncIntervalDesc": "检查远程更改的频率",
  "driveSync.excludePatterns": "排除模式",
  "driveSync.excludePatternsDesc": "从同步中排除的路径（每行一个，支持 * 通配符）",
  ...
  "driveSync.tempFilesDesc": "GemiHub 临时保存的文件",
  "driveSync.tempFilesTitle": "临时文件",
  "driveSync.tempFilesNoFiles": "没有找到临时文件。",
  "driveSync.tempFilesSavedAt": "保存时间：{{date}}",
  "driveSync.tempFilesApply": "应用所选",
  "driveSync.tempFilesApplyConfirm": "将所选临时文件应用到仓库？现有文件将被覆盖。",
  "driveSync.tempFilesDelete": "删除所选",
  "driveSync.tempFilesDeleteConfirm": "永久删除所选临时文件？",
  "driveSync.selectAll": "全部选择",
  "driveSync.conflictBackups": "冲突备份",
  "driveSync.conflictBackupsDesc": "冲突解决期间创建的备份文件",
  "driveSync.conflictBackupsTitle": "冲突备份",
  "driveSync.conflictBackupsNoFiles": "没有找到冲突备份。",
  "driveSync.conflictRestore": "恢复所选",
  "driveSync.conflictDelete": "删除所选",
  "driveSync.conflictDeleteConfirm": "永久删除所选冲突备份？",
  "driveSync.trash": "回收站",
  "driveSync.trashDesc": "同步期间删除的文件",
  "driveSync.trashTitle": "回收站",
  "driveSync.trashNoFiles": "回收站中没有文件。",
  "driveSync.trashRestore": "恢复所选",
  "driveSync.trashDeletePermanently": "永久删除",
  "driveSync.trashDeleteConfirm": "永久删除所选文件？此操作不可撤销。",
  "driveSync.manage": "管理",
  "driveSync.preview": "预览",
  "driveSync.previewBinary": "二进制文件 — 无法预览",
  "driveSync.previewFailed": "加载预览失败",
  "driveSync.processing": "处理中...",
  "driveSync.applied": "已应用 {{count}} 个文件",
  "driveSync.restored": "已恢复 {{count}} 个文件",
  "driveSync.deleted": "已删除 {{count}} 个文件",

  // Drive Sync - Plugin UI
  "driveSync.commandPush": "Drive同步：推送到云端",
  "driveSync.commandPull": "Drive同步：拉取到本地",
  "driveSync.commandFullPush": "Drive同步：完全推送到云端",
  "driveSync.commandFullPull": "Drive同步：完全拉取到本地",
  "driveSync.notUnlocked": "Drive 同步尚未解锁，请先输入密码。",
  "driveSync.unlocked": "Drive 同步已解锁",
  "driveSync.unlockFailed": "Drive 同步解锁失败：{{error}}",
  "driveSync.ribbonPush": "推送到云端",
  "driveSync.ribbonPull": "拉取到本地",
  "driveSync.ribbonPushCount": "推送到云端 ({{count}})",
  "driveSync.ribbonPullCount": "拉取到本地 ({{count}})",
  "driveSync.statusLocked": "Drive: 已锁定",
  "driveSync.statusLockedTooltip": "点击解锁 Drive 同步",
  "driveSync.statusPushing": "推送到云端中...",
  "driveSync.statusPulling": "拉取到本地中...",
  "driveSync.statusConflict": "Drive: 冲突",
  "driveSync.statusSynced": "Drive: 已同步",
  "driveSync.statusChanges": "Drive: {{changes}}",
  "driveSync.statusTooltip": "点击查看 Drive 同步操作",
  "driveSync.statusError": "Drive 同步：{{error}}",
  "driveSync.pushFailed": "推送到云端失败：{{error}}",
  "driveSync.pullFailed": "拉取到本地失败：{{error}}",
  "driveSync.refreshCounts": "刷新计数",
  "driveSync.tempUpload": "临时上传",
  "driveSync.tempDownload": "临时下载",
  "driveSync.tempUploadDone": "已上传到临时目录",
  "driveSync.tempDownloadDone": "临时文件已应用到 Vault",
  "driveSync.tempNotFound": "未找到此文件的临时文件",
  "driveSync.loadingFileList": "正在加载文件列表...",
  "driveSync.pushBlockedByRemote": "远程有待拉取的更改。请先拉取。",
  "driveSync.startPushing": "正在推送到 Drive...",
  "driveSync.startPulling": "正在从 Drive 拉取...",
  "driveSync.startFullPulling": "正在从 Drive 全量拉取...",
  "driveSync.startFullPushing": "正在全量推送到 Drive...",
