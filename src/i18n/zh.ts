...
export const zh: Record<string, string> = {
  ...
  "settings.editHistoryRetention": "保留策略",
  "settings.editHistoryMaxAge": "最大保存天数",
  "settings.editHistoryMaxAge.desc": "删除超过此天数的记录（0 = 不限制）",
  "settings.editHistoryMaxEntries": "每个文件的最大记录数",
  "settings.editHistoryMaxEntries.desc": "限制每个文件的记录数（0 = 不限制）",
  "settings.editHistoryContextLines": "上下文行数",
  "settings.editHistoryContextLines.desc": "差异中的上下文行数",
  "settings.editHistoryPrune": "清理旧记录",
  "settings.editHistoryViewStats": "查看统计",
  "settings.editHistoryPruned": "已清理 {{count}} 条旧记录",
  ...
  "driveSync.backupToken": "备份令牌",
  "driveSync.backupTokenDesc": "从 GemiHub 设置（Obsidian Sync 部分）粘贴备份令牌",
  "driveSync.backupTokenPlaceholder": "在此粘贴备份令牌",
  "driveSync.setupConnection": "配置连接",
  "driveSync.setupConnectionDesc": "使用备份令牌从 Google Drive 获取加密认证",
  "driveSync.setup": "配置",
  "driveSync.settingUp": "配置中...",
  "driveSync.pasteTokenFirst": "请先粘贴备份令牌",
  ...
  "driveSync.tempUploadDone": "已临时上传到 __TEMP__/",
