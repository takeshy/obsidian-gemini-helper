...
function normalizeDeprecatedModelName(model: unknown): ModelType | null | undefined {
  ...
  if (model === "gemini-3-flash-preview" || model === "gemini-3.5-flash" || model === "gemini-3.6-flash" || model === "gemini-3.7-flash") return "gemini-3.8-flash";
  if (model === "gemini-2.5-flash") return "gemini-3.8-flash";
